...
pub enum Op {
    ...
    CallIndirect { res: Option<Term>, func_ptr: Term },
...
impl fmt::Debug for Op {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Op::CallIndirect { res, func_ptr } => write!(f, "{}call indirect {:?}", fmt_opt(res), func_ptr),
            ...
            Op::BeginScopeOffset(i) => write!(f, "begin scope +{i}"),
